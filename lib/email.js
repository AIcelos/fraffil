...
const EMAIL_CONFIG = {
  ...
  domain: process.env.NODE_ENV === 'production' ? 'https://affiliate.filright.com' : 'http://localhost:3000'
};
    ...
    const content = `
        <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://affiliate.filright.com/dashboard/login" class="button">

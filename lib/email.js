...
const getPasswordResetTemplate = (name, resetToken) => {
    const content = `
        <div class="content">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="https://filright.com/reset-password?token=${resetToken}" class="button">
            ...
            <p class="text">
                ...
                <a href="https://filright.com/reset-password?token=${resetToken}" style="color: #667eea; word-break: break-all;">
                    https://filright.com/reset-password?token=${resetToken}
                </a>
            </p>
